...
raw_data <- raw_data %>% 
  mutate(life_expectancy = case_when(species == "chimpanzee" ~ 53,
                                     species == "ring_tailed_lemur" ~ 27,
                                     species == "bonobo"~ 40,
                                     species == "gorilla"~ 50,
                                     species == "black_and_white_ruffed_lemur"~ 19,
                                     species == "brown_capuchin_monkey" ~ 40,
                                     species == "black_faced_spider_monkey" ~ 40),
