...
labs <- data.frame(
  ...
  Site = as.factor(c("Wolfgang Köhler Primate Research Center", "Lincoln Park Zoo","Kumamoto Sanctuary","German Primate Center","Sweetwaters Chimpanzee Sanctuary","Heidelberg Zoo", "Edinburgh Zoo", "Kristiansand Zoo", "Monkey Haven","Language Research Center")),
