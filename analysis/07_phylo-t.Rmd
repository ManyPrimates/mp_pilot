...
*Question. Are we just using the first tree? --jw*
...
- Overlap with 1/3 ~ not better-than-chance performance
- This is only strictly the case for root node but it's close for a few, e.g. the new world monkey ancestor and lemur ancestor)
