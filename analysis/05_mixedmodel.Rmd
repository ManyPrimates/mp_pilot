...
# this suggests that random slopes for task experience does not make much sense as most species have only 1 level. Same is true for board size. Therefore they are removed

# trial random slopes within species also yields random effects equal to 0. Therefore it is removed 

# reduced model 

mm.2 <- glmer(correct ~ condition * norm_age + 
